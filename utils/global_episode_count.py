...
#----------------------------------------------KL_BETA------------------------------------------
def _init_kl_beta():
    global GLOBAL_KL_BETA,ADAPTIVE_LR
...
def _increase_kl_beta():
    ...
    ADAPTIVE_LR = ADAPTIVE_LR + 0.00001
    if GLOBAL_KL_BETA > 0.1:
        GLOBAL_KL_BETA = 0.1
    if ADAPTIVE_LR >0.0001:
        ADAPTIVE_LR = 0.0001
...
def _decrease_kl_beta():
    ...
    ADAPTIVE_LR = ADAPTIVE_LR - 0.000001
    if GLOBAL_KL_BETA <= 0:
        GLOBAL_KL_BETA = 0
    if ADAPTIVE_LR < 0.000001:
        ADAPTIVE_LR = 0.000001
